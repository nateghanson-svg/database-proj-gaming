...
Proposal: 
This will likely focus on only around 20 games from 5 platforms, including some on multiple platforms.
...
There will also be a transaction table to keep track of transactions.
